    ...
    <div className="flex flex-col min-h-screen">
       <header className="px-4 lg:px-6 h-16 flex items-center border-b z-10 bg-accent/60 text-accent-foreground backdrop-blur-sm fixed top-0 w-full">
          <Link href="/" className="flex items-center justify-center" prefetch={false}>
            ...
            <span className="ml-2 font-gothic text-lg font-semibold">Cruzados de la Vera Cruz</span>
          </Link>
      ...
      <main className="flex-1">
        <section className="relative w-full h-[60vh] md:h-[70vh] flex items-center justify-center">
          ...
          <div className="relative container px-4 md:px-6 text-center text-white">
            <div className="space-y-4">
              <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl lg:text-7xl/none font-gothic text-slate-300">
                CRUZADOS DE LA VERA CRUZ
              </h1>
              <p className="max-w-[700px] mx-auto text-xl md:text-2xl font-gothic font-medium text-slate-300">
        ...
        <section className="relative w-full py-12 md:py-24 lg:py-32 flex items-center justify-center">
            ...
            <div className="relative container px-4 md:px-6 text-white flex items-center justify-center">
              <div className="space-y-4 text-center">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-gothic">¿Quiénes somos?</h2>
                <p className="max-w-[900px] mx-auto text-base md:text-lg font-gothic">
        ...
        <section className="relative w-full py-12 md:py-24 lg:py-32 flex items-center justify-center">
            ...
            <div className="relative container px-4 md:px-6 text-white flex items-center justify-center">
              <div className="space-y-4 text-center">
                <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-gothic">¿Quieres Unirte?</h2>
                <p className="max-w-[900px] mx-auto text-base md:text-lg font-gothic">
          ...
          <section className="relative w-full py-12 md:py-24 lg:py-32 flex items-center justify-center">
              ...
              <div className="relative container px-4 md:px-6 text-white flex items-center justify-center">
                <div className="space-y-6 text-center">
                  <h2 className="text-3xl font-bold tracking-tighter sm:text-5xl font-gothic">Contáctenos</h2>
                    <ContactFormModal />
                </div>
              </div>
            </section>
      ...
      <footer className="flex flex-col gap-2 sm:flex-row py-6 w-full shrink-0 items-center px-4 md:px-6 border-t">
        <p className="text-xs text-muted-foreground md:text-sm font-gothic">&copy; 2024 Cruzados de la Vera Cruz. Que los vientos os sean favorables.</p>
        <nav className="sm:ml-auto flex gap-4 sm:gap-6">
          <Link href="/terms" className="text-xs hover:underline underline-offset-4 md:text-sm font-gothic" prefetch={false}>
            Leyes del Reino
          </Link>
          <Link href="/legal" className="text-xs hover:underline underline-offset-4 md:text-sm font-gothic" prefetch={false}>
